...
float Utils::bronzeShininess() { return 51.6f; }

// transparent MAterial
float* Utils::TransAmbient() { static float a[4] = { 1.0, 1.0, 1.0, 1.0 }; return (float*)a; }
float* Utils::TransDiffuse() { static float a[4] = { 1.0, 1.0, 1.0, 1.0 }; return (float*)a; }
float* Utils::TransSpecular() { static float a[4] = { 1.0, 1.0, 1.0, 1.0 }; return (float*)a; }
float Utils::TransShininess() { return 33.3f; }
